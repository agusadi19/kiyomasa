...
const starts = async (deff = new WAConnection()) => {
    ...
    deff.browserDescription = [ 'Hallo Temann', 'Safari', '0.0.1' ]
    ...
    deff.on('open', () => {
        success('2', 'Terhubung Jangan Lupa Subscribe Adiosbotz')
        setTimeout( () => { 	
	    	}, 1000)    		    	     	
    })
